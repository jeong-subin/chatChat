			...
			<table class="table table-bordered table-hover" style="text-align:center; border: 1px solid #dddddd">
				...
				<tbody>
					<tr>
						...
						<td style="width:110px;"><button class="btn btn-primary" data-toggle="model" onclick="registerCheckFunction();" type="button">중복체크</button></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td colspan="2"><input  class="form-control" type="text" id ="userName" name="userName" maxlength="20" placeholder="이름를 입력하세요"></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td colspan="2"><input  class="form-control" type="email" id ="userEmail" name="userEmail" maxlength="20" placeholder="이메일를 입력하세요"></td>
					</tr>
					<tr>
